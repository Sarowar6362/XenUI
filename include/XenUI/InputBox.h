...
#include "Position.h" // Assumes Position.h is public
//#include "../utils/ButtonStyle.h" // Reuse or adapt ButtonStyle if suitable
#include "TextRenderer.h" // Forward declare if possible? No, need getInstance type maybe. Include for now.
#include <string>
#include <functional>
#include <SDL2/SDL.h>
...
struct InputBoxStyle {
    SDL_Color bgColor = { 255, 40, 40, 255 };
